...
What is the type of 5 < 3? What does that stand for (should be familiar from Snap!)? Booleaon
What is the difference between == and = ? is it the exact same
What data type do you think my_favorite_animal == user_favorite_animal is? Booleaon
----------------------------
Part 2
----------------------------
...
What does 'and' do here? What type do you think can_get_license is? its like a +
...
What does = and == do here?     == is just picking 'cat' or 'dog'
